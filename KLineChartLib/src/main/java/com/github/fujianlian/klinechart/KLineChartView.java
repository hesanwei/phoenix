...
public class KLineChartView extends BaseKLineChartView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setSelectedXLineColor(getColor(R.color.chart_selector_y_line));
                setSelectedXLineWidth(getDimension(R.dimen.chart_line_width));

                setSelectedYLineColor(getColor(R.color.chart_selector_y_line));
                ...
                setGridRowLineColor(array.getColor(R.styleable.KLineChartView_kc_grid_line_color, getColor(R.color.chart_grid_line)));
                setGridRowLineWidth(array.getDimension(R.styleable.KLineChartView_kc_grid_line_width, getDimension(R.dimen.chart_grid_line_width)));
                //macd
    ...
    public void updateCurrPrice(float price, boolean isUp) {
        if (!isRefreshing) {
